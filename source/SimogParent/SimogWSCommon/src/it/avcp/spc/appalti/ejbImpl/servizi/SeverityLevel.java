...
public class SeverityLevel implements java.io.Serializable {
    ...
    public static final SeverityLevel INFO = new SeverityLevel(_INFO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servizi.ejbImpl.appalti.spc.avcp.it/", "severityLevel"));
    }
    /**
