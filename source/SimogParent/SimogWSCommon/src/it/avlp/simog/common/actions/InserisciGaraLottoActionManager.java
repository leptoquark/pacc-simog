...
//package it.avlp.simog.ws.actions;
//
...
//import it.avlp.simog.massload.xmlbeans.DatiGaraLottoDocument;
//import it.avlp.simog.ws.beans.Collaborazione;
//import it.avlp.simog.ws.beans.ResponseInserisciGaraLotto;
...
//
///**
// * classe che riceve un bean(xml) per l'inserimento di una gara e un lotto e
// * restituisce un cig.
// * @deprecated
// * nota: al momento l'unico abilitato e' rssa
// * */
public class InserisciGaraLottoActionManager {
//
//	/**
//	 * Il metodo permette l'inserimento dei dati Gara e Lotto
//	 * @param ticket : String
//	 * @param indexCollaborazione : String
//	 * @param datiGara : String contenete il file xml
//	 * @return
//	 * @deprecated : nota qualora fosse riattivato necessita di allineamento non e' garatito il funzionamento
//	 */
//	public synchronized static ResponseInserisciGaraLotto execute(String ticket, String indexCollaborazione,String datiGara){
//		//-------	object declarations		-------//
//		ResponseInserisciGaraLotto rgc = null;
//		Logger logger = null;
...
//			logger.info("-----------	begin  	---------------");
//			logger.info("eseguendo: ResponseInserisciGaraLotto execute(String ticket, String indexCollaborazione,GaraLotto datiGara)");
//			rgc = new ResponseInserisciGaraLotto();
...
//			wss.setComando("InserisciGaraLotto");
//			if(indexCollaborazione == null){
...
//				try{
//// 					tm.validateRequestedActionByProfile(wss,TicketManager.INSERISCI_GARA_LOTTO);
//					if(tm.isValido()){
...
//						DatiGaraLottoDocument garalotto = null;
//						try{
//							Collaborazione col = null;
//							if(!indexCollaborazione.equals("")){
//								col = tm.getCollaborazione();
//							}
//							garalotto = (DatiGaraLottoDocument)garaLottoManager.converti(datiGara, wss.getUserId(),col,"DatiGaraType");
//
...
//						wss.setSessionEnd(sqlt.increseSessionEnd(logger, sqlt.getDBDate(con, logger)));
//						try{
//							CIGBean cigb = garaLottoManager.inserisciGaraLotto(garalotto.getDatiGaraLotto().getDatiGara(), wss.getUserId(),tm.getCollaborazione(),
//																				tm.getAdminOr());
//							//se c'e' stato un'errore lancia l'eccezione passando la stringa contente gli errori del validatore
//							//attenzione in caso di errore il cigbean e' nullo
//							if(garaLottoManager.thereIsAnError()){throw new SimogWSException(garaLottoManager.getError());}
//							//altrimenti
//							rgc.setCig(cigb);
//							rgc.setId_gara(garaLottoManager.getId_gara());
