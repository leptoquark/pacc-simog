...
import it.avlp.simog.common.beans.ResponseModificaDatiPerfezionamento;
...
public class ModificaDatiPerfezionamentoActionManager {
	 ...
	 * @return
	 */	
	public synchronized static ResponseModificaDatiPerfezionamento execute(String ticket, String indexCollaborazione,
	      String cig, String dataScadenzaOfferte, String oraScadenzaOfferte, String dataScadenzaRicInvito){
		//-------	object declarations		-------//
		ResponseModificaDatiPerfezionamento rgc = null;
		Logger logger = null;
		...
		try{
			...
			rgc=new ResponseModificaDatiPerfezionamento();
			...
			wss.setComando("ModificaDatiPerfezionamento");
			...
			if(wss != null){
				...
				try{
					tm.validateRequestedActionByProfile(wss, TicketManager.MODIFICA_DATI_PERFEZIONAMENTO);
					if(tm.isValido()){
...
//                     }
							...
							Lotto lottoDatiPerfezionamento = new Lotto();
							if (dataScadenzaOfferte != null) {
								lottoDatiPerfezionamento.setDataScadenzaPagamenti(dataScadenzaOfferte);
							}
							if (oraScadenzaOfferte != null) {
								lottoDatiPerfezionamento.setORA_SCADENZA(oraScadenzaOfferte);
							}
							if (dataScadenzaRicInvito != null) {
								lottoDatiPerfezionamento.setDataScadenzaRichiestaInvito(dataScadenzaRicInvito);
							}
						
							
							// validazione dati ed integrazione sul db 
							boolean esito = garaLottoManager.modificaDatiPerfezionamento(lottoDatiPerfezionamento, wss.getUserId(),collsRssa,cig, tm.isOperaComeOsservatorio());
