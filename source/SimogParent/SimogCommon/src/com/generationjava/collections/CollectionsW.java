...
final public class CollectionsW {
    ...
    /********************************************
     * ottiene l'oggetto all'indice indicato
     * @param Object : obj  
     * @param  Object : index
     * @return Object
     */
    static public Object index(Object obj, Object index) {
        ...
        if(obj instanceof Enumeration) {
            Enumeration enumm = (Enumeration)obj;
    ...
    /*******************************************************
     * restituisce l'iteratore dell'oggetto indicato
     * @param Object : obj 
     * @return Iterator
     */
    ...
    /*****************************************************************
     * Ottine una Collection che e' una porzione di quelle passata come parametro,
     * Gli elementi contenuti saranno quelli compresi tra start ed end
     * 
     * @param Collectoin : coll
     * @param int : start
     * @param int : end
     * @return Collection
     */
    ...
    // unimplemented 
    /*********************************************
     * Crea una nuova Collection vuota
    ...
    /*********************************************
     * Inverte gli elementi del vettore in ingresso
     * @param Object[] : array
     */
    ...
    /// NOTODO: Improve this, so it takes start and end and is a slice()
    
    /***********************************************************
     * Ottiene una porzione di vettore consistente begli elementi 
     * che vanno dall'indice idx fino alla fine del vettore
     * @param String[] : ob
     * @param int : idx
     * @return String []
     */
    ...
    /***********************************************************
     * Da un iteratore ottiene un vettore
    ...
    /***********************************************************
     * Il metodo converte un iteratore in un vettore 
     * della tipologia incidata da type 
     * 
     * @param Iterator : iterator
     * @param Object[] : type
     * @return Object[]
