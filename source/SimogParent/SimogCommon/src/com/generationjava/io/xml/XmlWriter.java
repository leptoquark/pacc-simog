...
public class XmlWriter {
    ...
    private int level;			// livello tabulazione
     ...
     * @param String name of entity.
     */
    public XmlWriter writeTextEntity(String name, String text) throws WritingException {
        try {
            closeOpeningTag();
            this.writer.write("\n" + addTab(this.level) + "<");
            this.writer.write(name);
     ...
     * entity.
     */
    public XmlWriter endEntity(boolean newline) throws WritingException {
        try {
            if(this.stack.empty()) {
    ...
    /****************************************************************
     * Aggiunge i tab \t a seconda del valore di level
     * @param int : level
     * @return String
     */
