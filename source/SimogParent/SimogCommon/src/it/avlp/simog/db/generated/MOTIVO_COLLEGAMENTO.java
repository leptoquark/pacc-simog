package it.avlp.simog.db.generated; 
	/*
	*	FILE MOTIVO_COLLEGAMENTO created mer 27/02/2019 14:46:00:000
	*/

public class MOTIVO_COLLEGAMENTO {

	public final static String TABLE_NAME = "MOTIVO_COLLEGAMENTO";


	public final static String ID_MOTIVO = "ID_MOTIVO";
	public final static String T_ID_MOTIVO = TABLE_NAME + "." + ID_MOTIVO;
		// COLUMN TYPE [bigint]
		// COLUMN SIZE [19]
		// NULLABLE [NO]

	public long Id_motivo_field;
	...
	public final static String ORDINAMENTO = "ORDINAMENTO";
