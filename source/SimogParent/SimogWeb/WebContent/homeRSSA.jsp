...
<title>SIMOG - Gestione Gare RSSA</title>
</head>
...
<div class="bodypage-e">
	...
	<div> 
		...
		<div class="bodypage-b">
			...
			<p><utils:message key="home.guidaServizio" /> <a href="<%= it.avlp.simog.common.servlet.ParametriServlet.HELP_GUIDA_RSSA %>" target="_blank"><utils:message key="menu.guidaServizio" /></a>!</p>
			<p><utils:message key="home.indicazioniAggiornate" /></p>
		</div>
		<div class="bodypage-c">
			<h4><utils:message key="home.creazioneGare" /></h4>
			<p><utils:message key="home.codificaGare" /></p>
			<p><utils:message key="home.menuNavigazione" /></p>
			<p><utils:message key="home.creazioneNuovaGara" /></p>
		</div>
		<div class="bodypage-d">
			...
			<p><strong><utils:message key="home.perfezionamentoComunicazione" /></strong> <strong><utils:message key="home.sistemaRiscossione" /></strong></p>
		</div>	
	</div>
	</div>
