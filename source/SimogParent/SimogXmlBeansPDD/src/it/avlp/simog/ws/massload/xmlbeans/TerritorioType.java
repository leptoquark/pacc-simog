...
/**
 * <p>Java class for TerritorioType complex type.
 * 
...
public class TerritorioType {
    ...
    protected List<LuogoIstatType> codRegioneIstat;
     ...
     * 
     */
    public List<LuogoIstatType> getCodRegioneIstat() {
        if (codRegioneIstat == null) {
            codRegioneIstat = new ArrayList<LuogoIstatType>();
        }
