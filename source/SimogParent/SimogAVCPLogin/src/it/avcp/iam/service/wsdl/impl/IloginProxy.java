...
public class IloginProxy implements it.avcp.iam.service.wsdl.impl.Ilogin {
  private String _endpoint = null;
  private it.avcp.iam.service.wsdl.impl.Ilogin ilogin = null;
  ...
  private void _initIloginProxy() {
    try {
      ilogin = (new it.avcp.iam.service.wsdl.impl.IloginserviceLocator()).getIloginPort();
      if (ilogin != null) {
        if (_endpoint != null)
  ...
  public it.avcp.iam.service.wsdl.impl.Ilogin getIlogin() {
    if (ilogin == null)
      _initIloginProxy();
    return ilogin;
  }
